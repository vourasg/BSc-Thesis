			...
			<div id="page">
				...
				<div id="contents">
					...
					<div class="box">
						<div>
							<div class="body">
								<h2>Αναφορες σε εξελιξη στο δημο  <?php echo $_SESSION['locality']; ?></h2>
								<p>
									<?php
										//connect to DB
										...
										$sql = "SELECT * FROM reports where state='in progress' AND locality='".$_SESSION['locality']."';";

			...
			<div id="page">
				...
				<div id="contents">
					...
					<div class="box">
						<div>
							<div class="body">
								<h2>Ανοικτες Αναφορες στο δημο <?php echo $_SESSION['locality']; ?></h2>
								<p>
									<?php
										//connect to DB
										...
										$sql = "SELECT * FROM reports where state='open' AND locality='".$_SESSION['locality']."';";
											...
											?><div margin='0 auto;'>
												<table border='.5'; bordercolor='green';>
													<tr><th height=15>ID</th><th height=15>Τοποθεσία</th><th height=15>Περιγραφή</th><th height=15>Εξέταση</th>
														<tr><td height=140; width=30; align='right'><?php echo $row['ID'] ?></td>
